...
use_int        = int(sys.argv[16])  # 1 for performing PLDA interpolation, else 0
use_gmm        = int(sys.argv[17])  # 1 for adding utterance-specific threshold, else 0
