Implementation of diarization baseline for the [Third DIHARD Speech Diarization Challenge (DIHARD III)](https://dihardchallenge.github.io/dihard3/). The baseline is based on [LEAP Lab's](http://leap.ee.iisc.ac.in/) [DIHARD II](https://dihardchallenge.github.io/dihard2/) submission:
